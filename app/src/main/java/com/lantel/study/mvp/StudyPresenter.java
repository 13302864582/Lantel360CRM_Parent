...
public class StudyPresenter extends StudyContract.Presenter{
    ...
    public void initMenu() {
        ...
        String[] titles = resources.getStringArray(R.array.study_menu_title);
        String[] router_paths = resources.getStringArray(R.array.study_menu_router_path);
        TypedArray icons = resources.obtainTypedArray(R.array.study_menu_icon);
